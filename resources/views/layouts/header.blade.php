    ...
    <div class="menu">
        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            ...
            <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                <a class="dropdown-item d-flex align-items-center" href="{{ route('profile.edit') }}">PROFILE <i class="bi bi-person-circle ms-auto text-theme fs-16px my-n1"></i></a>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                <a class="dropdown-item d-flex align-items-center" href="{{ route('logout') }}" onclick="event.preventDefault();this.closest('form').submit();">LOGOUT <i class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></a>
                </form>
            </div>
        </div>
    </div>
